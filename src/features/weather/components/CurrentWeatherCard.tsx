...
const CurrentWeatherCard = ({data,location}:CurrentWeatherProps) => {
  ...
  return (
            <Card className="overflow-hidden flex-none md:flex-1 border border-indigo-500/60">
                     ...
                     <div className="grid gap-6 md:grid-cols-2">
                           <div className="space-y-6">
                              ...
                              <div className="flex flex-col items-center justify-center">
                                <div className="relative flex aspect-square w-full max-w-45 items-center justify-center">
